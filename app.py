...
if st.button("Fertig"):
    ...
    chart = alt.Chart(chart_df).mark_bar(size=20).encode(
        ...
        row=alt.Row('Frage:N', title=None, header=alt.Header(labelAngle=90, labelPadding=0, labelAlign='left')),  # Fragen werden untereinander dargestellt, Abstand reduziert
